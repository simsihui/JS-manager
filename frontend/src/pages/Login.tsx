          ...
          {haveAccount ? (
            <Box
              className={`my-4 flex min-w-[33%] flex-col items-center justify-center gap-1 ${
                haveAccount ? "animate-slide-up md:animate-slide-left" : ""
              }`}
            >
            ...
            <Paper
              ...
              className={`flex grow items-center justify-center rounded-3xl ${
                haveAccount ? "" : "z-10 animate-slide-up md:animate-slide-left"
              }`}
            >
              <SignUp />
            </Paper>
          ...
          {haveAccount ? (
            <Paper
              ...
              className={`z-10 flex grow items-center justify-center rounded-3xl ${
                haveAccount ? "animate-slide-down md:animate-slide-right" : ""
              }`}
            >
              <SignIn />
            </Paper>
